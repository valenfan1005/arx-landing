...
_EXTRA_CRYPTO = {
    "sol":  {"api_name": "SOL",  "display": "Solana",      "symbol": "SOL",  "icon": "/img/coins/sol.png"},
    "hype": {"api_name": "HYPE", "display": "Hyperliquid", "symbol": "HYPE", "icon": "https://coin-images.coingecko.com/coins/images/50882/small/hyperliquid.jpg"},
    "xrp":  {"api_name": "XRP",  "display": "XRP",         "symbol": "XRP",  "icon": "/img/coins/xrp.png"},
    "doge": {"api_name": "DOGE", "display": "Dogecoin",    "symbol": "DOGE", "icon": "https://coin-images.coingecko.com/coins/images/5/small/dogecoin.png"},
    "arb":  {"api_name": "ARB",  "display": "Arbitrum",    "symbol": "ARB",  "icon": "https://coin-images.coingecko.com/coins/images/16547/small/arb.jpg"},
    "op":   {"api_name": "OP",   "display": "Optimism",    "symbol": "OP",   "icon": "https://coin-images.coingecko.com/coins/images/25244/small/Optimism.png"},
    "sui":  {"api_name": "SUI",  "display": "Sui",         "symbol": "SUI",  "icon": "/img/coins/sui.png"},
    "apt":  {"api_name": "APT",  "display": "Aptos",       "symbol": "APT",  "icon": "https://coin-images.coingecko.com/coins/images/26455/small/aptos_round.png"},
    "avax": {"api_name": "AVAX", "display": "Avalanche",   "symbol": "AVAX", "icon": "https://coin-images.coingecko.com/coins/images/12559/small/Avalanche_Circle_RedWhite_Trans.png"},
    "link": {"api_name": "LINK", "display": "Chainlink",   "symbol": "LINK", "icon": "https://coin-images.coingecko.com/coins/images/877/small/chainlink-new-logo.png"},
    "uni":  {"api_name": "UNI",  "display": "Uniswap",     "symbol": "UNI",  "icon": "/img/coins/uni.jpg"},
    "aave": {"api_name": "AAVE", "display": "Aave",        "symbol": "AAVE", "icon": "https://coin-images.coingecko.com/coins/images/12645/small/aave-token-round.png"},
    "mkr":  {"api_name": "MKR",  "display": "Maker",       "symbol": "MKR",  "icon": "https://coin-images.coingecko.com/coins/images/1364/small/Mark_Maker.png"},
    "pepe": {"api_name": "kPEPE","display": "PEPE",        "symbol": "PEPE", "icon": "/img/coins/pepe.jpg", "price_divisor": 1000},
    "wif":  {"api_name": "WIF",  "display": "dogwifhat",   "symbol": "WIF",  "icon": "/img/coins/wif.jpg"},
    "jup":  {"api_name": "JUP",  "display": "Jupiter",     "symbol": "JUP",  "icon": "https://coin-images.coingecko.com/coins/images/34188/small/jup.png"},
    "tia":  {"api_name": "TIA",  "display": "Celestia",    "symbol": "TIA",  "icon": "https://coin-images.coingecko.com/coins/images/31967/small/tia.jpg"},
    "sei":  {"api_name": "SEI",  "display": "Sei",         "symbol": "SEI",  "icon": "/img/coins/sei.png"},
}
...
for _slug, _info in _EXTRA_CRYPTO.items():
    if _slug not in MARKET_CONFIG:
        ...
        MARKET_CONFIG[_slug] = {
            ...
            "symbol": _sym,
            "category": "crypto",
            "icon": _info.get("icon", f"https://coin-images.coingecko.com/coins/images/1/small/{_slug}.png"),
